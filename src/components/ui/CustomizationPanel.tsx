        ...
        <div className='px-4 pb-4 space-y-6'>
          ...
          <div className='space-y-3'>
            ...
            <div className='flex gap-2'>
              <button
                ...
                className={cn(
                  ...
                  resourcesMode === 'global' ? 'bg-primary text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200',
                )}
              >
                Para toda la clase
              </button>
            ...
            {resourcesMode === 'global' ? (
              <FontSelector fonts={fonts} selectedFontId={globalFontId} onSelect={onGlobalFontChange} />
            ) : (
