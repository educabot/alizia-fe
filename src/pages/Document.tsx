...
export function Document() {
  ...
  useEffect(() => {
    ...
    const hasContent = Object.values(currentDocument.sections).some(
    ...
    // Only trigger on document load, not on every state change
  ...
  const handlePublish = async () => {
    ...
    try {
      ...
      await refetchDocument();
      // Also refresh the list cache so the home/list pages show the new status
      ...
      <div className='flex-1 flex overflow-hidden p-6 gap-6'>
        ...
        <div className='flex-1 flex flex-col activity-card-bg rounded-2xl overflow-hidden'>
          ...
          <div className='flex-1 overflow-y-auto p-6 space-y-4'>
            {showPublishErrors && !isPublished && !isGenerating && <PublishValidation document={currentDocument} />}
            {isGenerating ? (
          ...
          <div className='w-80 flex flex-col activity-card-bg rounded-2xl overflow-hidden'>
            ...
            <div className='flex-1 overflow-y-auto p-4'>
              {isGeneratingClasses ? (
                ...
                <ClassPlanTable subjects={currentDocument.subjects} readOnly={isReadOnly || isPublished} />
              )}
            </div>
          </div>
        )}
